...
$lang = array_merge($lang, [
	...
	'PATREON_SUPPORTERS_TITLE'		=> 'Nuestros mecenas',
	'PATREON_SUPPORTERS_EXPLAIN'	=> 'Estos miembros de la comunidad nos apoyan a través de Patreon.',
	'PATREON_SUPPORTERS_TIER'		=> 'Nivel',
	'PATREON_SUPPORTERS_PLEDGE'		=> 'Pledge',
	'PATREON_SUPPORTERS_NONE'		=> 'No hay mecenas para mostrar en este momento.',

	'NOTIFICATION_TYPE_AVATHAR.BBPATREON.NOTIFICATION.TYPE.PATREON_LINKED'	=> 'Alguien vincula su cuenta de Patreon',
	...
	'LOG_PATREON_TIER_UNMAPPED'			=> '<strong>Nivel de Patreon sin asignar:</strong> el patrocinador activo con ID de usuario %1$s está en el nivel %2$s, que no tiene ninguna asignación de grupo configurada; sus grupos existentes no se modificaron',
