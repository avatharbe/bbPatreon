...
$lang = array_merge($lang, [
	...
	'ACP_BBPATREON_TIER_MAPPING_EXPLAIN'	=> 'Koppel elke Patreon-tier aan één of meerdere phpBB-gebruikersgroepen. Wanneer een patron op een bepaalde tier pledgt, wordt hij aan alle bijbehorende groepen toegevoegd. Bij wisseling van tier wordt hij naar de groepen van de nieuwe tier verplaatst en uit de oude verwijderd. Bij annulering wordt hij uit alle patrongroepen verwijderd (afhankelijk van de gratieperiode). Klik op "Tiers ophalen" om je tiers automatisch te laden.',
	...
	'ACP_BBPATREON_FETCH_TIERS_DONE'		=> '%d tier(s) opgehaald van Patreon. Selecteer één of meerdere groepen voor elke tier en klik op Verzenden.',
	'ACP_BBPATREON_TIER_ID'					=> 'Patreon Tier-ID',
	'ACP_BBPATREON_PHPBB_GROUP'				=> 'phpBB-groep(en)',
	'ACP_BBPATREON_SELECT_GROUP'			=> '-- Selecteer groep --',
	'ACP_BBPATREON_MULTI_GROUP_EXPLAIN'		=> 'Selecteer één of meerdere groepen. De patron wordt toegevoegd aan elke aangevinkte groep voor zijn tier.',
	...
	'ACP_BBPATREON_SET_DEFAULT_GROUP'		=> 'Set tier group as default',
	'ACP_BBPATREON_SET_DEFAULT_GROUP_EXPLAIN'	=> 'When enabled, promoting a patron to a tier-mapped group also sets that group as their default phpBB group (so the patron\'s username takes on the group\'s colour and rank). On demotion (cancellation or grace-period expiry) their default is reset to the Registered users group. Leave disabled to add the tier group as a secondary membership only — the patron\'s pre-existing default group stays unchanged.',
