...
$lang = array_merge($lang, [
	...
	'ACP_BBPATREON_TIER_MAPPING_EXPLAIN'	=> 'Map each Patreon tier to one or more phpBB usergroups. When a patron is pledging at a given tier, they are added to every mapped group. If they switch tiers, they are moved to the new tier\'s groups and removed from the old ones. If they cancel, they are removed from all patron groups (subject to the grace period). Click "Fetch Tiers" to load your tiers from Patreon automatically.',
	...
	'ACP_BBPATREON_FETCH_TIERS_DONE'		=> '%d tier(s) fetched from Patreon. Select one or more groups for each tier and click Submit.',
	'ACP_BBPATREON_TIER_ID'					=> 'Patreon Tier ID',
	'ACP_BBPATREON_PHPBB_GROUP'				=> 'phpBB Group(s)',
