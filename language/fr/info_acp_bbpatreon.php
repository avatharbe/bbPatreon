...
$lang = array_merge($lang, [
	...
	'ACP_BBPATREON_TIER_MAPPING_EXPLAIN'	=> 'Associez chaque palier Patreon à un ou plusieurs groupes phpBB. Cliquez sur "Récupérer les paliers" pour charger vos paliers automatiquement.',
	...
	'ACP_BBPATREON_FETCH_TIERS_DONE'		=> '%d palier(s) récupéré(s) de Patreon. Sélectionnez un ou plusieurs groupes pour chaque palier et cliquez sur Soumettre.',
	'ACP_BBPATREON_TIER_ID'					=> 'ID du palier Patreon',
	'ACP_BBPATREON_PHPBB_GROUP'				=> 'Groupe(s) phpBB',
	'ACP_BBPATREON_SELECT_GROUP'			=> '-- Sélectionner un groupe --',
	'ACP_BBPATREON_MULTI_GROUP_EXPLAIN'		=> 'Sélectionnez un ou plusieurs groupes. Le patron est ajouté à chaque groupe coché pour son palier.',
