...
$lang = array_merge($lang, [
	...
	'PATREON_SUPPORTERS_TITLE'		=> 'Os nossos apoiantes',
	'PATREON_SUPPORTERS_EXPLAIN'	=> 'Estes membros da comunidade apoiam-nos através do Patreon.',
	'PATREON_SUPPORTERS_TIER'		=> 'Nível',
	'PATREON_SUPPORTERS_PLEDGE'		=> 'Pledge',
	'PATREON_SUPPORTERS_NONE'		=> 'Nenhum apoiante para mostrar neste momento.',

	'NOTIFICATION_TYPE_AVATHAR.BBPATREON.NOTIFICATION.TYPE.PATREON_LINKED'	=> 'Alguém vincula a sua conta Patreon',
	...
	'LOG_PATREON_TIER_UNMAPPED'			=> '<strong>Nível do Patreon não mapeado:</strong> o apoiador ativo com ID de utilizador %1$s está no nível %2$s, que não tem nenhum mapeamento de grupo configurado — os seus grupos existentes foram mantidos',
